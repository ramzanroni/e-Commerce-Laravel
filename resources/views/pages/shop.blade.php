                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        <div class="product__discount__item__pic set-bg"
                                            data-setbg="{{ asset($product->product_img_1) }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{ asset($productp->product_img_1) }}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="/add-wishlist/{{ $productp->id }}"><i class="fa fa-heart"></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <form action="{{ 'add_to_cart/'.$productp->id }}" method="POST">
                                            @csrf
                                            <input type="text" name="price" value="{{ $productp->price }}" hidden>
                                            <li><button class="rounded-circle" type="submit"><i class="fa fa-shopping-cart"></i></button></li>
                                        </form>
                                    </ul>
                                </div>
                                <div class="product__item__text">
                                    <h6><a href="#">{{ $productp->product_name }}</a></h6>
                                    <h5>${{ $productp->price }}</h5>
                                </div>
                            </div>
                        </div>
