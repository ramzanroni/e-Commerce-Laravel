...
<body>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                @auth
                                <a href="/home"><i class="fa fa-user float-left"></i>My Account</a>
                                @else
                                <a href="/login"><i class="fa fa-user float-left"></i>Login</a>
                                @endauth
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        @php
                            $total_cart_price=App\Models\Cart::all()->where('user_ip', request()->ip())->sum(function($product_price){
                               return $product_price->qty*$product_price->price;
                            });
                            $total_cart_qty=App\Models\Cart::where('user_ip', request()->ip())->sum('qty');

                            $total_wishlist=App\Models\Wishlist::where('user_id', Auth::id())->get();
                        @endphp
                        <ul>
                            <li><a href="/wishlist"><i class="fa fa-heart"></i> <span>{{ count($total_wishlist) }}</span></a></li>
                            <li><a href="/cart"><i class="fa fa-shopping-bag"></i> <span>{{ $total_cart_qty }}</span></a></li>
                        </ul>
                        <div class="header__cart__price">item: <span>${{ $total_cart_price }}</span></div>
                    </div>
                </div>
            </div>
  ...
  Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This develop by Ramzan <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://ramzanali.xyz" target="_blank">Ramzan Ali</a>
